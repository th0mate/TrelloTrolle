...
class UtilisateurRepositoryTest extends TestCase
{
    ...
    public function testRecupererUtilisateursOrderedPrenomNom(){
        ...
        $fakeUtilisateur3 = new Utilisateur('bob560','zeblouse','agathe','agathe.zeblouze@jfiu.com','mdp');
    ...
    public function testRechercheNom(){
        $fakeUtilisateur1= new Utilisateur('bob560','zeblouse','agathe','agathe.zeblouze@jfiu.com','mdp');
    ...
    public function testAjouterUtilisateur(){
        $fakeUtilisateur1= new Utilisateur('nv69','Nouveau','nouvo','nouvo.nouveau@nouvo.com','nouvo');
    ...
    public function testMettreAjour(){
        $fakeUtilisateur1= new Utilisateur('bob69','bobby','bobby','bobby.bobby@bob.com','mdpBob');
